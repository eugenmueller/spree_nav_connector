...
Gem::Specification.new do |s|
  ...
  s.name        = 'spree_nav_connector'
  s.version     = SpreeNavConnector.version
  s.summary     = 'Navision 2017 Connector'
  s.description = 'Spree Engine connect Spree Commerce with Navision 2017'
